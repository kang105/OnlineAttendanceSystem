...
<body>
	...
	<center>
		...
		<form
			action="${ pageContext.request.contextPath }/manager/attend_search_time"
			method="post">
			<br /> <br />开始日期:<br /> <br> <input type="text"
				class="demo-input" id="test1" name="bdate" placeholder="请选择日期">
			...
			<br /> <br /> <br />结束日期:<br /> <br> <input type="text"
				class="demo-input" id="test2" name="edate" placeholder="请选择日期">
			<script src="../resources/laydate/laydate.js"></script>
			<!-- 改成你的路径 -->
			<script>
				lay('#version').html('-v' + laydate.v);
			...
			<br /> <br />
			<button type="submit" class="btn btn-primary">搜索考勤</button>
			<br> <br>
		</form>
			...
			<table class="table table-striped">
				...
				<tbody>
					<c:forEach items="${paginationSupport.items }" var="attendance"
						varStatus="vs">
						<tr>
							<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="10%">${attendance.id }</td>
							<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="10%">${attendance.member.userName }</td>
							<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">${attendance.attendDate }</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
